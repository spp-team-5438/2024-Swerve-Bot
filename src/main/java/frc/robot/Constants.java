...
public final class Constants {
    ...
    public static final double stickDeadbandXR = 0.18;
    public static final double stickDeadbandYR = 0.18;
    public static final double stickDeadbandXL = 0.18;
    public static final double stickDeadbandYL = 0.18;
    ...
    public static final class Swerve {
        ...
        public static final class Mod2 {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-29);
        ...
        public static final class Mod3 {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(87);
            public static final boolean driveMotorInvert = false;
            public static final boolean angleMotorInvert = false;
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, encoderID,
    ...
    public static final class SpeakerConstants {
        ...
        public static final int aprilTagCentralSpeaker = 3;
        public static final int aprilTagOffsetSpeaker = 4;
    }
